...
<table border="2" align="center">
        ...
        foreach ($catalog->childNodes as $book)
        {
            ...
            $author = $book->getElementsByTagName("msnv")->item(0)->nodeValue;
            $title = $book->getElementsByTagName("hoten")->item(0)->nodeValue;
            $genre = $book->getElementsByTagName("ngaysinh")->item(0)->nodeValue;
            $price = $book->getElementsByTagName("diachi")->item(0)->nodeValue;
            $publish_date = $book->getElementsByTagName("namtd")->item(0)->nodeValue;
            $description = $book->getElementsByTagName("chucvu")->item(0)->nodeValue;
